...
\pagebreak
	...
	% TODO: wrzucić diagram klas i krótko opisać, w jaki sposób są przetwarzane dane wejściowe, jak działa algorytm i co jest na wyjściu. Nie skupiać się na architekturze aplikacji okienkowej i testach
	
	\subsection{Testy jednostkowe}
	
	% TODO: co było zrobione w testach, screen z zielonych testów
	
	\subsection{Testy akceptacyjne i wydajnościowe}
	
	% TODO: przykłady wraz ze znalezionymi rozwiązaniami, dodatkowo można walnąć ze dwa testy pokazujące to, że czas rośnie n^2 * log n
	
	\section{Instrukcja użytkownika}
	
	% TODO: To na koniec: jak już będzie wszystko, po prostu trzeba będzie odpalić aplikację okienkową
